...
UOEIVoiceOverComponent::UOEIVoiceOverComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
...
void UOEIVoiceOverComponent::Play(const FVoiceOverData& Data, float StartTime, const FSpeakerPlaybackStartedDynamicDelegate& PlaybackStarted) const {
}
